...
//    public $mail_host='smtp.qq.com'; //邮件发送SMTP服务器 default
    public $mail_host='smtp.galison.co';
    //public $mail_port=465;
    public $mail_port = 22;
    public $mail_smtopauth=true;
   // public $mail_username='3340404772@qq.com'; //SMTP服务器登陆用户名
    public $mail_username='order@galison.co';
    //public $mail_password='avntltfprxrccgja'; //SMTP服务器登陆密码
    public $mail_password='Gala_galison+999';
